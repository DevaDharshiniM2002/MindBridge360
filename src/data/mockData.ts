...
export const I18N_TEXT = {
  en: {
    ...
    onboardingTitle: 'Welcome to MindMitra',
    ...
    privacyPoints: [
      ...
      'Predict & Prevent: MindMitra anticipates academic stress surges before they peak.',
    ...
    consentButton: 'I Understand & Agree (Enter MindMitra)',
  ...
  ta: {
    ...
    sanctuarySub: 'மாணவர் நல்வாழ்வு தளம் - MindMitra',
    onboardingTitle: 'மைண்டமித்ரா-விற்கு வரவேற்கிறோம்',
